...
(function(){
	...
	function ListController(quizMetrics) {
		...
		var vm = this; //vm -> view-modal
        vm.quizMetrics = quizMetrics;
		vm.data = turtlesData; // binding turtlesdata to data
		vm.activeTurtle = {};
	...
	var turtlesData = [
        {
            type: "Green Turtle",
            image_url: "http://yourshot.nationalgeographic.com/u/ss/fQYSUbVfts-T7pS2VP2wnKyN8wxywmXtY0-FwsgxoJVbovrSAQ4Z9u_yFL_UwgmudkrvP04AdAZg2EGHBQTv/",
